...
//alert("Function Get Fee Data call Successfully"); 
session_id=value;
...
{                       
		...
		{ 
					...
					content+="<tr class='money'><th>Fee Type</th><th>Month</th><th>Fee Amount</th><th>Status</th></tr>";
...
//BACK button code START
						...
						{
							document.getElementById("feeTable").innerHTML="<p style='margin-left:10px;'>Oops! There doesn't seem to be any data!</p>";
						$.mobile.loading('hide');  
						document.location="#feeDetail";
						return false;
					    }
...
content +="</tr>";
content+='</table>';
document.getElementById('paymentTable').innerHTML=content;
document.location="#paymentInfo";
//BACK button code START
